...
namespace MythrenFighter {
    ...
    public class EOSSDKManager : MonoBehaviour
    {
        ...
        [Header("SDK Keys")]
        public string epicProductName = "MythrenFighter";
        ...
        protected static EOSSDKManager instance;
        protected static EOSSDKManager Instance
        {
            get { return instance; }
        }
        ...
        protected void InitializeImplementation()
        {
            ...
            LoggingInterface.SetCallback(message => Debug.Log(message.Message));
